...
export const DEFAULT_ROLE_ID = 'awesome-dsh-pet'
/** 角色 id 合法字符集（URL 路径安全；与 verify-assets 门禁一致）。 */
export const ROLE_ID_RE = /^[a-z0-9-]+$/

/** 从 manifest 提取角色索引：顶层 `states` 简写 → 单角色。返回 { characters, defaultId }。 */
 ...
 * verify-assets 门禁保证 manifest 必含全部 15 状态）。
 */
