...
function apply(ctx = {}) {
  ...
  const resolveAssetUrl = typeof ctx.resolveAssetUrl === "function" ? ctx.resolveAssetUrl : (url) => url;
  const startWindowDrag = typeof ctx.startWindowDrag === "function" ? ctx.startWindowDrag : null;
