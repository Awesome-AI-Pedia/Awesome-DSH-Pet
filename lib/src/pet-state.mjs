...
export const INITIAL_STATE = Object.freeze({
  level: 1,
  xp: 0,
  stats: Object.freeze({ tasksDone: 0, failures: 0, sessions: 0, activeMs: 0, firstSeenAt: null }),
...
export function recordSessionResume(state, nowMs) {
  return commit(state, {}, nowMs, '回到已有会话，继续陪伴', RESUME_XP)
}
