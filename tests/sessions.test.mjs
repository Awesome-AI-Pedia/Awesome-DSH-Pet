...
// GET /awesome-dsh-pet/sessions 的每会话活动账本（thinking / tool:<name> / waiting / done）。
...
test('session/title → 标题（不改活动）', () => {
  assert.deepEqual(parseSessionEvent(ev('session/title', { title: 'awesome-dsh-pet 二次开发', messageSeqs: [1], source: { kind: 'fallback' } })),
    { kind: 'title', value: 'awesome-dsh-pet 二次开发' })
})
